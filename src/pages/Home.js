        ...
        <div className=" relative">
            ...
            <section>
                <div className='flex gap-12 p-12 justify-center mt-12'>
                    <a target='_blank' className='opacity-80 hover:opacity-100 transition-all duration-300 ease-in-out' href='https://t.me/BardAi_ERC'><img src={tel} /></a>
                    <a target='_blank' className='opacity-80 hover:opacity-100 transition-all duration-300 ease-in-out' href='https://www.dextools.io/app/en/ether/pair-explorer/0x948b0bab68c1fbd6af824a0ad56513c8dd3bb778'><img src={dex} /></a>
                    <a target='_blank' className='opacity-80 hover:opacity-100 transition-all duration-300 ease-in-out' href='https://twitter.com/bardai_erc20'><img src={twt} /></a>
                    <a target='_blank' className='opacity-80 hover:opacity-100 transition-all duration-300 ease-in-out' href='https://etherscan.io/address/0x3b88BB02BD2F50EEdf30DE6B94Cd5351CecD3658'><img src={eth} /></a>
                </div>
                <br/>
